...
-- Key mappings
vim.keymap.set('n', '<Leader>q', function() close_buffer_or_vim(false) end, { silent = true })
vim.keymap.set('n', '<Leader>Q', function() close_buffer_or_vim(true) end, { silent = true })
